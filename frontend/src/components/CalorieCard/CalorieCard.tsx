...
export const CalorieCard = ({ consumed, goal, remaining }: CalorieCardProps) => {
  const percentage = Math.min((consumed / goal) * 100, 100);
  
  return (
    <Card className="p-6 floating-card bg-gradient-to-br from-white to-primary/5 border-primary/20">
      <div className="text-center space-y-4">
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          ...
          <div>
            <div className="text-lg font-semibold text-success">{remaining}</div>
