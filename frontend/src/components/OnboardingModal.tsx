...
import { ArrowRight, ArrowLeft, User, Activity, Target, Sparkles } from 'lucide-react';
      ...
      <DialogContent className="sm:max-w-[500px]" onInteractOutside={(e) => e.preventDefault()}>
        <DialogHeader>
          ...
          <DialogDescription className="text-center">
            {step === 1 && "Inserisci le tue informazioni base per calcolare il fabbisogno calorico"}
          ...
          <div className="space-y-4">
              ...
              <SelectContent>
                <SelectItem value="sedentary">
                  <div className="flex flex-col items-start">
                    ...
                    <span className="text-xs text-muted-foreground">Poco o nessun esercizio</span>
                  </div>
                </SelectItem>
                <SelectItem value="light">
                  <div className="flex flex-col items-start">
                    <span className="font-medium">Leggermente attivo</span>
                    <span className="text-xs text-muted-foreground">Esercizio leggero 1-3 giorni/settimana</span>
                  </div>
                </SelectItem>
                <SelectItem value="moderate">
                  <div className="flex flex-col items-start">
                    <span className="font-medium">Moderatamente attivo</span>
                    <span className="text-xs text-muted-foreground">Esercizio moderato 3-5 giorni/settimana</span>
                  </div>
                </SelectItem>
                <SelectItem value="active">
                  <div className="flex flex-col items-start">
                    <span className="font-medium">Molto attivo</span>
                    <span className="text-xs text-muted-foreground">Esercizio intenso 6-7 giorni/settimana</span>
                  </div>
                </SelectItem>
                <SelectItem value="extra-active">
                  <div className="flex flex-col items-start">
                    <span className="font-medium">Estremamente attivo</span>
                    <span className="text-xs text-muted-foreground">Esercizio molto intenso, lavoro fisico</span>
                  </div>
                </SelectItem>
              </SelectContent>
            </Select>
            ...
            <div className="bg-primary/5 p-4 rounded-lg border border-primary/20">
              ...
              <p className="text-sm text-muted-foreground">
                Il livello di attività ci aiuta a calcolare con precisione il tuo fabbisogno calorico giornaliero
              </p>
            </div>
          </div>
        )}
        ...
        {step === 3 && (
          <div className="space-y-4">
            <RadioGroup value={formData.goal} onValueChange={(value) => updateField('goal', value)}>
              <div className="flex items-start space-x-3 p-4 rounded-lg border-2 border-border hover:border-primary transition-colors cursor-pointer">
                ...
                <Label htmlFor="lose-weight" className="cursor-pointer flex-1">
                  ...
                  <div className="text-sm text-muted-foreground">Deficit calorico per dimagrimento graduale</div>
                </Label>
              </div>
              ...
              <div className="flex items-start space-x-3 p-4 rounded-lg border-2 border-border hover:border-primary transition-colors cursor-pointer">
                ...
                <Label htmlFor="maintain" className="cursor-pointer flex-1">
                  ...
                  <div className="text-sm text-muted-foreground">Equilibrio calorico per peso stabile</div>
                </Label>
              </div>

              <div className="flex items-start space-x-3 p-4 rounded-lg border-2 border-border hover:border-primary transition-colors cursor-pointer">
                <RadioGroupItem value="gain-weight" id="gain-weight" className="mt-1" />
                <Label htmlFor="gain-weight" className="cursor-pointer flex-1">
                  <div className="font-medium">Aumentare la massa</div>
                  <div className="text-sm text-muted-foreground">Surplus calorico per crescita muscolare</div>
                </Label>
              </div>
            </RadioGroup>
            ...
            <div className="bg-primary/5 p-4 rounded-lg border border-primary/20">
              ...
              <p className="text-sm text-muted-foreground">
                Calcoleremo il tuo fabbisogno calorico ideale in base al tuo obiettivo
              </p>
            </div>
          </div>
        )}
        ...
        <div className="flex justify-between gap-3 mt-6">
          ...
          {step < totalSteps ? (
            ...
            <Button onClick={handleSubmit} disabled={isLoading} className="flex-1 ml-auto">
              {isLoading ? (
                <>
